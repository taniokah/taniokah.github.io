...
<div style="text-align: right;">
  <a href="./index.html">ホーム</a> / <a href="./football.en.html">English</a>
</div>
...
**谷岡 広樹**は、2024年4月より徳島大学サッカー部の顧問に着任し、大学サッカーの現場に関わっています。

徳島大学では、**機械学習、データ分析、画像認識、オブジェクトトラッキング、スポーツデータ解析**を専門とし、サッカーを含むスポーツ分野への応用研究に取り組んでいます。

サッカーに関しては、競技経験、JFA公認指導者資格、大学サッカー部での顧問経験に加え、サッカースクール、選手位置推定、映像解析、戦術分析、スポーツ統計に関する研究・発表実績を有しています。

特に、以下のテーマに力を入れています。

- **サッカーにおけるデータサイエンスの活用**
- **選手行動分析・位置推定・映像解析**
- **AI・データ分析を活用した指導・育成支援**
...
| 資格名 | 発行日 |
|---|---|
| JFA公認キッズリーダー | 2015年10月13日 |
| JFA公認D級コーチ | 2016年3月23日 |
| JFA公認C級コーチ | 2017年7月26日 |
| 認定ワークショップデザイナー（マスター）| 2021年3月16日 |

現在、JFA公認C級コーチとして登録されています。  
また、付加ライセンスとしてキッズリーダーを保有しています。
...
| 期間 | チーム | 主な成績 |
|---|---|---|
| 1981年4月〜1986年3月 | 撫養SC | 1984年 西日本少年サッカー大会 準優勝 |
| 1989年4月〜1992年3月 | 鳴門高校サッカー部 |  |
| 1998年4月〜2001年3月 | BREZZA FC（徳島県社会人3部） |  |

小学生年代から社会人年代までサッカーを経験し、現在は研究者・教育者・JFA公認指導者として、サッカー現場におけるデータ活用、選手行動分析、指導支援に取り組んでいます。

---

## サッカー関連の研究業績

サッカーに関する主な研究テーマは、**データサイエンスを用いた選手行動分析、サッカースクールの教育効果分析、映像解析による物体検出・追跡、戦術分析支援**です。

徳島ヴォルティス株式会社との共同研究では、サッカースクールにおける楽しさ、運動量、ボール関与、指導改善に関する分析に取り組みました。
...
- 谷岡 広樹, 郡 涼太.  
  [**回帰分析を用いたサッカーJ1リーグにおける攻撃力と守備力の分析**](https://sports.ywebsys.net/news/archives/0013/)  
  スポーツデータ解析における理論と事例に関する研究集会, Vol.8, 2021.  
  [KAKEN](https://kaken.nii.ac.jp/ja/grant/KAKENHI-PROJECT-18H03344/) / [Program](https://sports.ywebsys.net/news/archives/0013/)

- 谷岡 広樹, 木村 薫, 箭野 柊.  
  [**ロジスティック回帰を用いた得点チャンスの分析**](https://2018.sports.ywebsys.net/news/archives/0008/)  
  スポーツデータ解析における理論と事例に関する研究集会 / 第8回スポーツデータ解析コンペティション, 2018.  
  [Program](https://2018.sports.ywebsys.net/news/archives/0008/)

- 森井 理智, 谷岡 広樹.  
  [**得点できる攻撃パターンは? - ディープラーニングを用いた得点予測**](https://db.db.tokushima-u.ac.jp/Assistance/browse?eid=336777)  
  スポーツデータ解析における理論と事例に関する研究集会, Vol.5, 2018.  
  [徳島大学 教育研究者総覧](https://db.db.tokushima-u.ac.jp/Assistance/browse?eid=336777)
...
サッカーは、技術・体力・戦術だけでなく、観察力、判断力、協調性、継続力が求められるスポーツです。  
試合やトレーニングの中には、選手の動き、判断、位置取り、関係性、攻守の切り替えなど、多くの情報が含まれています。

画像解析、位置推定、マルチオブジェクトトラッキング、統計解析、機械学習を活用することで、これらの情報を可視化し、現場で活用可能な形に整理することを目指しています。

### 学生主体のチーム活動

徳島大学サッカー部では、学生自身が課題を見つけ、仲間と共有し、改善に向けて取り組む過程を大切にしています。  
顧問として、学生が主体的にチームを運営し、競技力と人間的成長の両方を高められるよう支援しています。

### 競技経験・指導者資格・研究の接続

自身のサッカー経験、JFA公認指導者資格、スポーツデータ解析の研究経験を組み合わせ、大学サッカーの現場に貢献することを目指しています。  
特に、AIやデータサイエンスの知見を活かし、選手一人ひとりが自分の可能性を広げられるような支援に取り組んでいます。

---

## 活動方針

徳島大学サッカー部では、学生が主体的に考え、判断し、行動することを大切にしています。  
勝利を目指す競技活動であると同時に、大学生活の中で仲間とともに成長できる場であることを重視しています。

主な活動方針は以下の通りです。

- **学生主体のチーム運営を尊重すること**
- **競技力向上と人間的成長を両立すること**
- **サッカーを通じて観察力・判断力・協調性を育むこと**
- **データや映像を活用し、振り返りと改善につなげること**
- **大学生活の中で継続的に挑戦できる環境を支援すること**

---

## メッセージ

徳島大学サッカー部での活動を通じて、競技力の向上だけでなく、人としての成長につながる経験を積んでほしいと考えています。

サッカーは、仲間とともに考え、挑戦し、失敗から学び、再び立ち上がるスポーツです。  
大学サッカーの時間が、学生一人ひとりにとって、競技面でも人間的にも大きく成長できる機会となるよう支援していきます。

データサイエンスやAIの知見も活かしながら、選手一人ひとりが自分の可能性を広げられるよう、チーム活動を支援していきます。
...
- [四国大学サッカー連盟](https://www.jufashikoku.com/)
- [一般財団法人全日本サッカー連盟](https://www.jufa.jp/)
- [一般社団法人徳島県サッカー協会](https://tokushima-fa.jp/)
- [公益財団法人日本サッカー協会](https://www.jfa.jp/)
- [日本フットボール学会](https://www.jssf.net/)
